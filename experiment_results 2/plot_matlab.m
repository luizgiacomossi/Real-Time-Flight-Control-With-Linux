...
selection = 'deadline'; % options: 'other', 'rr', 'deadline', 'fifo'
...
myTitle = sprintf('Latency for Scheduler: %s R400 ', schedulerName);
...
yscale log
yticks([0,5,10,25,50,100,1000,10000])
yticklabels([0,5,10,25,50,100,1000,10000])
...
ylabel('Latency ($\mu$s)', 'Interpreter', 'latex', 'FontSize', fontSize);
xlabel('Iteration', 'Interpreter', 'latex', 'FontSize', fontSize);
myTitle = sprintf('Latency for Scheduler: %s R800', schedulerName);
title(myTitle, 'Interpreter', 'latex', 'FontSize', fontSize);
legend({'Stress', 'No Stress'}, 'Interpreter', 'latex', 'FontSize', fontSize, 'Location', 'best');
