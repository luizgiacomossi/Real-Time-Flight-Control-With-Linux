...
%selection = 'other'; % options: 'other', 'rr', 'deadline', 'fifo'
selections = ["other", "rr", "deadline", "fifo"];
for selection = selections
    ...
    myTitle = sprintf('Latency for Scheduler: %s n0', schedulerName);
    ...
    yscale log
    yticks([0,5,10,25,50,100,200,1000,10000])
    yticklabels([0,5,10,25,50,100,200,1000,10000])
    ...
    ylabel('Latency ($\mu$s)', 'Interpreter', 'latex', 'FontSize', fontSize);
    xlabel('Iteration', 'Interpreter', 'latex', 'FontSize', fontSize);
    myTitle = sprintf('Latency for Scheduler: %s n-19', schedulerName);
    title(myTitle, 'Interpreter', 'latex', 'FontSize', fontSize);
    legend({'Stress', 'No Stress'}, 'Interpreter', 'latex', 'FontSize', fontSize, 'Location', 'best');
    ...
    filename = selection + "_latency_comparison.pdf"
